...
export default function ListDeleteAllScreen({navigation}: RootTabScreenProps<"ListDeleteAll">) {
        ...
        <ScrollView style={styles.container}>
            <View style={styles.outer}>
               ...
               <View style={{marginTop: 40, borderWidth:2, borderRadius: 20,
                   ...
                   <Text style={{fontSize:28, marginRight: "auto", marginLeft: "auto"}}>Delete All? </Text>
                   ...
                   <Text style={{marginLeft: "auto", marginRight: "auto"}}>Are you sure you want to clear the wishList?</Text>
                   <View style={{marginRight: "auto", marginTop: 20, marginLeft: "auto", flex: 1, flexDirection: "row"}}>
                       ...
                       <View style={{flex: 1, flexDirection: "column", marginRight: 20}}>
                           <ButtonBlack text="Clear" onPress={deleter} disabled={loading}/>
                       </View>
                   </View>
               </View>
            </View>
